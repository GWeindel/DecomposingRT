...
MT_fit = LME.sampling(data=MT_LME_data, iter=2000, chains=6, n_jobs=6, warmup = 1000,  control=dict(adapt_delta=0.99, max_treedepth=15))
stan_utility.check_treedepth(MT_fit)
...
MT_fit.to_netcdf("FittedModels/MT_Exp1_fit.nc")
